    ...
    LatestRoom.Changed:Connect(function()
        if not opened and LatestRoom.Value == 1 then
            ...
            task.spawn(function()
                local c = 0
                while true do
                    SyncWait(c + 650); LatestRoom.Changed:Wait(); LoadEntity("Rebound")
                    SyncWait(c + 1400); LatestRoom.Changed:Wait(); LoadEntity("Rebound")
                    c = c + 930
            ...
            task.spawn(function()
                local c = 0
                while true do
                    SyncWait(c + 1000); LoadEntity("A60")
                    SyncWait(c + 2100); LoadEntity("A60")
                    c = c + 910
            ...
            task.spawn(function()
                local c = 0
                while true do
                    SyncWait(c + 1580); LoadEntity("DeerGod")
                    c = c + 2100
